...
//  Clique
//
//  Created by Rod Tavangar on 6/25/25.
//
...
extension View {
    ...
    @ViewBuilder func shimmer() -> some View {
        self
            .modifier(ShimmerEffectHelper(config: .init(tint: .gray, highlight: .white, blur: 15, highlightOpacity: 1, speed: 1, blendMode: .overlay)))
    }
}
